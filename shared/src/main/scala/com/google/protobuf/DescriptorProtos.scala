...
object DescriptorProtos {
  ...
  class FieldOptions extends Message with GeneratedMessageV3.ExtendableMessage[FieldOptions]
  class EnumOptions extends Message with GeneratedMessageV3.ExtendableMessage[EnumOptions]
  class EnumValueOptions extends Message with GeneratedMessageV3.ExtendableMessage[EnumValueOptions]
